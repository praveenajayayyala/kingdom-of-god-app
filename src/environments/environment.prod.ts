export const environment = {
    ...
    redirecPBtUrl: "https://www.kingdomofgod.in/page-builder",
    ...
    loginPBUrl: "https://kingdomofgod.auth.ap-south-1.amazoncognito.com/oauth2/authorize?client_id=vclkssn2ftril9vhgbscnc46r&response_type=code&scope=aws.cognito.signin.user.admin+email+openid+phone&redirect_uri=https://www.kingdomofgod.in/page-builder",
